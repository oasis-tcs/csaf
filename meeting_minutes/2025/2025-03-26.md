...
- Issue [#884](https://github.com/oasis-tcs/csaf/issues/884)
  ...
  - Thomas specifies under "Distribution" have a new property called `license`, and would hold the identifier.
  ...
  - Thomas moves to add a `license` identifier under "Distribution" for CSAF v2.1. Omar modifies the motion to specify that this is an optional field.
