...
- Issue [#1086](https://github.com/oasis-tcs/csaf/issues/1086)
...
- 2025 CSAF Workshops
  ...
  - Omar seconds. No discussion, no objections. Motion passed.
- Justin proposes that we have an additional meeting in August to review the comments from CSD-01 and have our regularly scheduled meeting to wrap up any oustanding issues needed for discussion to make sure we can get the next CSD-02 out for public review.
  - Thomas agrees this could be good to have an additional meeting in August.
  - It is proposed to have the meeting on Wednesday August 20th, 2025 at 13:00 ET (to follow the monthly OASIS OpenEoX Meeting)
  - Justin sets the motion to have an additional TC meeting in August on the Wednesday, August 20th, 2025 at 13:00 ET
    - Thomas asks for the clarification if the meeting will counts toward voting eligibility?
    - Response is yes.
    - Omar seconds the motion. No discussion or objections. Motion passed.
    - Omar will send the invite for the August 20th meeting.
  - Thomas mentions the presentation from Christian Banse upcoming for August 18th on the CSAF integration into DependencyTrack (SBOM Matching System).
    - Link: https://groups.oasis-open.org/discussion/save-the-date-csaf-sbom-matching-presentation-2025-08-18
