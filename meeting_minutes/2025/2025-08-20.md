...
- Issue [#1125](https://github.com/oasis-tcs/csaf/issues/1125)
  ...
  - Thomas Schmidt moves to reject the suggestion made in Issue [#1125](https://github.com/oasis-tcs/csaf/issues/1125) and to not change the field as discussed.
...
- Issue [#1068](https://github.com/oasis-tcs/csaf/issues/1068)
  ...
  - Thomas Schmidt sets the motion not to implement any change in CSAF v2.1 for this Issue but open an issue to track integration of other BOMs for future considerations in future versions of CSAF.
  - Vijay Saverapelli asks for clarification how this will be tracked. Thomas Schmidt responds that it while it will not be actively tracked, the Issue will remain open for future considerations.
  - Sonny van Lingen seconded the motion. No discussion, no objections. Motion passed.
