...
- Motion to select Thomas Schmidt as acting chair for today's meeting passes with no objections, no discussion, and unanimuos consent
- Motion to select Thomas Schmidt as acting chair for today's meeting passes with no objections, no discussion, and unanimuos consent
- Agenda approved
...
- CSAF 2.1
  ...
  - Thomas presents [Support CVSS 4.0 in CSAF 2.x #652](https://github.com/oasis-tcs/csaf/issues/652)
