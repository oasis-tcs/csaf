...
- Idea:
  ...
  - Jane reports that the  The Open Cybersecurity Alliance (OCA) Cybersecurity Automation Subproject (CASP) is planning a plug fest (near Washington DC area)
    ...
    - Thomas kindly asks Hane to provide the info also on the TC mailing list
    - Jane will do so (Update after meeting: mail senr and received: <https://lists.oasis-open.org/archives/csaf/202401/msg00007.html>)
  - Mailing list
