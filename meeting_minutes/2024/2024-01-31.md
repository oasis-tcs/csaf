...
- Idea:
  ...
  - Mailing list
    ...
    - Thomas Schmidt moves to establish a mailing list for announcements for non-tc-members to subscribe to and request the officers of the TC to implement that in collaboration with OASIS administration and interested parties (for hosting)
      - Tobias seconds
