...
- Pull-request – Schema identifier added to JSONs #753
  - As soon as Stephen has double checked, then Thomas Schmidt will set motion for editor revision.
- Pull-Request TC discussion – handling the lack of CVSS string (CSAF specifications 6.1.8) #754.
  ...
  - Thomas Schmidt to document comments.
- Pull-request Revisit #662 Add remediation category “fix_planned”!
  ...
  - Toby not in meeting today to weigh in. 
...
- Pull-request Add list of organizations publishing CSAF on website #686.
  ...
  - Covered by CSAF aggregators? Is that their purpose.  They collect who they are publishing, CSAF may not be compliant, but can’t retrieve automatically.  
