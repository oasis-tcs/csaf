...
Product-level Extensions (`x_extensions`) of value type Extensions Type (`extensions_t`) contains a list of extensions valid at
the full product name element level of the CSAF document.
