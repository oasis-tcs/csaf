...
> In the preceding example \[[eg](#product-tree-property-relationships-eg-1)\], it might be the case that
> `Cisco AnyConnect Secure Mobility Client 4.9.04053"` is only vulnerable when installed on `Microsoft Windows`.
