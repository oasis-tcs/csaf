...
CVSS_40_STRICT_SCHEMA=csaf_2.1/referenced_schema/first/cvss-v4.0.json
CVSS_META_SCHEMA=csaf_2.1/referenced_schema/first/meta.json
EXTENSION_CONTENT_SCHEMA=csaf_2.1/json_schema/extension-content.json
...
EXCLUDE='oasis_csaf_tc-csaf_2_1-2024-6-1-07-06.json|oasis_csaf_tc-csaf_2_1-2024-6-1-08-01.json|oasis_csaf_tc-csaf_2_1-2024-6-1-08-02.json|oasis_csaf_tc-csaf_2_1-2024-6-1-08-03.json|oasis_csaf_tc-csaf_2_1-2024-6-1-08-04.json|oasis_csaf_tc-csaf_2_1-2024-6-1-08-05.json|oasis_csaf_tc-csaf_2_1-2024-6-1-08-06.json|oasis_csaf_tc-csaf_2_1-2024-6-1-09-05.json|oasis_csaf_tc-csaf_2_1-2024-6-1-37-01.json|oasis_csaf_tc-csaf_2_1-2024-6-1-37-02.json|oasis_csaf_tc-csaf_2_1-2024-6-1-37-03.json|oasis_csaf_tc-csaf_2_1-2024-6-1-37-04.json|oasis_csaf_tc-csaf_2_1-2024-6-1-37-05.json|oasis_csaf_tc-csaf_2_1-2024-6-1-37-06.json|oasis_csaf_tc-csaf_2_1-2024-6-1-46-01.json|oasis_csaf_tc-csaf_2_1-2024-6-1-46-02.json|oasis_csaf_tc-csaf_2_1-2024-6-1-60-01-01.json|oasis_csaf_tc-csaf_2_1-2024-6-1-60-01-02.json|oasis_csaf_tc-csaf_2_1-2024-6-2-10-01.json|oasis_csaf_tc-csaf_2_1-2024-6-2-20-01.json|oasis_csaf_tc-csaf_2_1-2024-6-2-20-02.json'
...
validate() {
  ...
  if python3 $VALIDATOR $SCHEMA $1 ${CVSS_20_STRICT_SCHEMA} ${CVSS_30_STRICT_SCHEMA} ${CVSS_31_STRICT_SCHEMA} ${CVSS_40_STRICT_SCHEMA} ${CVSS_META_SCHEMA} ${META_SCHEMA} ${SSVC_200_SL_SCHEMA} ${EXTENSION_CONTENT_SCHEMA} ${EXTENSION_META_SCHEMA}; then
    printf "%s\n" SUCCESS
  else
    printf "%s\n" FAILED
    FAIL=1
